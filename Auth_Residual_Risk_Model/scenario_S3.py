...
if os.path.exists("S3_runs_summary.csv"):
    os.remove("S3_runs_summary.csv")
...
# ---------------------------------
solver = z3.Solver()
ast = z3.parse_smt2_file("/Users/kabashi/Desktop/The model copy/adapt_model_S3.smt2")
solver.add(ast)
...
def run_residual_with_bound(target_rr, rr_band=0.019, timeout_ms=30000, max_iters=200, min_step=0.012):
    """
    ...
    ast_res = z3.parse_smt2_file("/Users/kabashi/Desktop/The model copy/residual_model_S3.smt2")
    base.add(ast_res)
